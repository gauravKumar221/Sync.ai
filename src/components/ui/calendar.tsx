  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md w-full justify-start font-normal text-sm p-2",
      ...
      components={{
        ...
        DayContent: (dayProps: DayContentProps) => {
          const { date } = dayProps;
          if (props.components?.DayContent) {
            const CustomDayContent = props.components.DayContent;
